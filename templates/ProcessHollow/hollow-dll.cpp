...
unsigned char zwQueryInformationProcess_str[] = { 'Z','w','Q','u','e','r','y','I','n','f','o','r','m','a','t','i','o','n','P','r','o','c','e','s','s', 0x00};
...
extern "C" {
	...
	int sleep_time = 0;
        ...
        // create a 400 byte of NOPs to store data read
        BYTE data[400];
        for (int i = 0; i < sizeof(data); i++) { data[i] = 0x00; }

        // read in 400 bytes of memory at address of image base (\x4d\x5a\x90..MZ..)
